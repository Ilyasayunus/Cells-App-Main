...
@section('container')
    <div class="row">
        <div class="col-lg-8">
            <form method="POST" action="/admin/indikator/{{ $data->id }}" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_indikator" name="nama_indikator"
                        value="{{ $data->nama_indikator }}" required autofocus>
                </div>
                <div class="mb-3">
